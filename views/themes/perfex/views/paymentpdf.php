...
if($amountDue){
    $tblhtml .= '<td style="color:#fc2d42">' . format_money(get_invoice_total_left_to_pay($payment->invoice_data->id, $payment->invoice_data->total), $payment->invoice_data->symbol) . '</td>';
}
$tblhtml .= '</tr>';
$tblhtml .= '</tbody>';
$tblhtml .= '</table>';
