...
<div class="checklist mbot25 relative" data-checklist-id="<?php echo $list['id']; ?>">
    <div class="checkbox checkbox-success checklist-checkbox" data-toggle="tooltip" title="">
        ...
        <textarea data-taskid="<?php echo $task_id; ?>" name="checklist-description" rows="1" class="ays-ignore"><?php echo clear_textarea_breaks($list['description']); ?></textarea>
