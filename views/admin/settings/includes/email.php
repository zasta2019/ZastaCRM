...
<div class="tab-content">
	...
	<div role="tabpanel" class="tab-pane" id="email_queue">
		...
		<hr />
		<?php render_yes_no_option('email_queue_skip_with_attachments','email_queue_skip_attachments','Most likely you will encounter problems with the email queue if the system need to add big files in the queue. If you plan to use this option consult with your server administrator/hosting provider to increase the max_allowed_packet option, otherwise when this option is set to yes the system won\'t add emails with attachments in the queue and will sent immediately.'); ?>
	</div>
</div>
